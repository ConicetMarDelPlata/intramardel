<?php
	...
	//$puede_entrar = $bd->getPermisos($userData,'CAN_ACCESS_PROC');
...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  <tr>
    <td class="cerrar"><p><strong><img src="images/bullet20.gif" width="9" height="9" /> <?php echo 'Usuario: '. $nombre_usuario ?></strong></p>
      <p>&nbsp;</p></td>
	<?php
		$permAlta = $bd->checkPerm($_SESSION["id_usuario"],18,'alta');	    	
		if($permAlta){
  	  		echo '<td align="left" valign="middle"><span class="TITULO">:: Procedimientos ::</span><a href="form_procedimiento.php?opcion=1"><img src="agregar.png" width="25" height="25" border="0"></a></td>';
		}else
			echo '<td align="left" valign="middle"><span class="TITULO">:: Procedimientos ::</span><a href="#"><img src="iconos_grises/agregarg.png" width="25" height="25" border="0"></a></td>';
	?>
  </tr>
  <tr>
    ...
    <td width="722" valign="top"> 
      <?php
			$bd->lista_procedimientos($nombre_usuario);
			$bd = NULL;
		?>
    </td>
  </tr>
