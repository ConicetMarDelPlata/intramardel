...
function enviar(form){
	...
	if (document.form3.opcion.value != 2){ //SI NO ELIJE ELIMINAR
		...
		{
			alert("El t&iacute;tulo de la noticia es obligatorio.");
			return (false);
		}
		else
			//enviar = window.confirm('Se enviar&aacute;n todos los datos del formulario');
...
function enviar6(form){
	document.form3.opcion.value = 9;
	document.form3.submit();
}
</script>
...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  <tr>
    ...
    <td align="left" valign="middle"><span class="TITULO">:: 
      Noticias ::</span>
	  <?php
		$webNotAlta = $bd->checkPerm($_SESSION["id_usuario"],30,'alta');
		echo '<a href="'; 
		echo ($webNotAlta)?"form_noticia.php?opcion=1":"#"; 
		echo '"><img src="';
...
?>
      ...
      <form action="abm_noticia.php" method="post" enctype="multipart/form-data" name="form3" id="form3">
        <table align="center" class="tabla_form">
          ...
          <tr> 
            ...
            <?php 
				echo '<td class="modo2"><div align="left"><input name="titulo" type="text" id="titulo" value="' . $titulo .'"' . 'size="55" maxlength="85"></td>';
			?>
          </tr>
          <tr> 
	  ...
	  ?>
		...
		<script type="text/javascript"> 
			...
			button     :    "lanzador_fecha"     // el id del bot&oacute;n que lanzar&aacute; el calendario 
		}); 
          ...
          <!--<tr> 
            <td class="modo1">
				<div align="right">
					<font color="#000099">
						<strong>Cargar Im&aacute;genes:</strong>
					</font>
				</div>
			</td>
			<td class="modo2" style="text-align:left">
				<form name="upload_imagenes" action="upload_images_noticias.php" method="POST" enctype="multipart/form-data">
					<input type="hidden" value="<?php echo $id_noticia; ?>" name ="id"/>
					<input name="imagenes[]" type="file" multiple="multiple" />
				</form>
			</td>
          </tr>-->	  
          <tr> 
            <td class="modo1">
				<div align="right">
					<font color="#000099">
						<strong>Admin. Im&aacute;genes:</strong>
					</font>
				</div>
			</td>
			<td class="modo2" style="text-align:left">
				<input type="button" value="Administrar" onclick="Administrar(<?php echo $id_noticia; ?>);"/>
			</td>
		<tr> 
            <td class="modo1"><div align="right"><font color="#000099"><strong>Adjunto:</strong></font></div></td>
            <?php 
			echo '<td class="modo1"><input name="adjunto" id="adjunto" type="file" value=""></td>';
			if ( ($opcion ==3) && ($adjunto) ){
				echo '<td><button type="button" name="Btn_enviar" id="Btn_enviar" onClick="enviar6(form)" alt="Eliminar Adjunto"><img src="eliminar.png" width="30" heigth="30" border="0"></button></td>';
			}
				//echo '<td><img src="../fotos_noticias/'. $adjunto . '" width="60" height="60" border="0"></td>';
			?>
          </tr>	  
          <tr> 
