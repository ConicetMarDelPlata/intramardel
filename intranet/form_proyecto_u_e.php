<?php
	...
	//$puede_entrar = $bd->getPermisos($userData,'CAN_ACCESS_UE');
	$puede_entrar = $bd->checkAccess($_SESSION["id_usuario"],22,''); //22-web ue
...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  <tr>
    ...
    <td align="left" valign="middle"><span class="TITULO">:: 
      Proyectos Unidades Ejecutoras ::</span>
	  <?php
		$webPUEAlta = $bd->checkPerm($_SESSION["id_usuario"],22,'alta');
		echo '<a href="'; 
		echo ($webPUEAlta)?"form_proyecto_u_e.php?opcion=1":"#"; 
		echo '"><img src="';
		echo ($webPUEAlta)?"agregar.png":"iconos_grises/agregarg.png";
    ...
    <td width="722" valign="top"> <p> 
		...
		switch ($opcion){
			...
			case 3: // OPCION MODIFICACION
				$id_proyecto_u_e = $_GET['id_unidad_ejecutora'];
...
?>
      ...
      <form action="abm_proyecto_u_e.php" method="post" enctype="multipart/form-data" name="form3" id="form3">
	...
	?>
		...
		switch ($opcion){
			...
			case 2: // BAJA 
				...
				echo '<input type="hidden" name="id_proyecto_u_e" id="id_proyecto_u_e" value="'.$id_proyecto_u_e.'">';				
