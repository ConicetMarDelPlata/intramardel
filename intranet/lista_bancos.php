<?php
	...
	//$puede_entrar = $bd->getPermisos($userData,'CAN_ACCESS_BAN');
	$puede_entrar = $bd->checkAccess($_SESSION["id_usuario"],13,''); //13-bancos
...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  <tr>
   ...
   <?php
		...
		$bancosAlta = $bd->checkPerm($_SESSION["id_usuario"],13,'alta');
		if($bancosAlta){
  	  		echo '<td align="left" valign="middle"><span class="TITULO">:: Bancos ::</span><a href="form_banco.php?opcion=1"><img src="agregar.png" width="25" height="25" border="0"></a></td>';
		}else
			echo '<td align="left" valign="middle"><span class="TITULO">:: Bancos ::</span><a href="#"><img src="iconos_grises/agregarg.png" width="25" height="25" border="0"></a></td>';
	?>	 
  </tr>
  <tr>
    <td width="170" valign="top" background="images/divisor-columna.jpg" bgcolor="#FFFFFF" class="tituloweb2" style="background-repeat: no-repeat; background-position: right;">
		<?php include_once("templates/menuLateral-bases.php");?>
	</td>
    <td width="722" valign="top"> 
      <?php
			$bd->lista_bancos($nombre_usuario);
			$bd = NULL;
		?>
    </td>
  </tr>
