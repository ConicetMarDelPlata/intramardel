<?php
	...
	$puede_entrar = $bd->checkAccess($_SESSION["id_usuario"],21,''); //21=web coop i
...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  <tr>
    ...
    <td align="left" valign="middle"><span class="TITULO">:: 
      Proyectos de Cooperaci&oacute;n Internacional ::</span>	  <?php
		$webPCIAlta = $bd->checkPerm($_SESSION["id_usuario"],21,'alta');
		echo '<a href="'; 
		echo ($webPCIAlta)?"form_proyecto_c_i.php?opcion=1":"#"; 
		echo '"><img src="';
		echo ($webPCIAlta)?"agregar.png":"iconos_grises/agregarg.png";
    ...
    <td width="722" valign="top"> <p> 
		...
		switch ($opcion){
			...
			case 3: // OPCION MODIFICACION
				$id_proyecto_c_i = $_GET['id_proyecto_c_i'];
...
?>
      ...
      <form action="abm_proyecto_c_i.php" method="post" enctype="multipart/form-data" name="form3" id="form3">
	...
	?>
		...
		switch ($opcion){
			...
			case 2: // BAJA 
				...
				echo '<input type="hidden" name="id_proyecto_c_i" id="id_proyecto_c_i" value="'.$id_proyecto_c_i.'">';				
