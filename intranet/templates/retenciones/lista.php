...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  ...
  <tr>
	...
	<td align="left" valign="middle">
		<span class="TITULO">:: Reporte de Retenciones ::</span>
	</td>
  </tr>
  <tr>
    ...
    <td width="722" valign="top" id="lista_actas">
		<form name="frm_inv" action="reporte_arba_pdf.php" method="POST" target="_blank">
				...
				<tr class="modo1">				
					...
					<td>
						<select name="iUE">
							...
							<!--BEGIN BLOCK UE-->
							<option value="{var_iUE}" cuit="{var_sUE_CUIT}">{var_sUE}</option>
							<!--END BLOCK UE-->
						</select>
					</td>
				</tr>
