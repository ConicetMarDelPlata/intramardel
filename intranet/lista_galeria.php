<?php
	...
	$puede_entrar = $bd->checkAccess($_SESSION["id_usuario"],29,''); //29-web galeria de imagenes
...
<html>
<head>
<title>Lista Galeria de Imagenes</title>
...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  <tr>
    <td class="cerrar"><p><strong><img src="images/bullet20.gif" width="9" height="9" /> <?php echo 'Usuario: '. $nombre_usuario ?></strong></p>
      <p>&nbsp;</p></td>
    <td align="left" valign="middle"><span class="TITULO">:: Galer&iacute;a de Im&aacute;genes ::</span>
	  <?php
		$permAlta = $bd->checkPerm($_SESSION["id_usuario"],29,'alta');
		echo '<a href="'; 
		echo ($permAlta)?"form_album_fotos.php?opcion=1":"#"; 
		echo '"><img src="';
  ...
  <tr>
    ...
    <td width="722" valign="top"> 
      <?php
			$bd->lista_album_fotos($nombre_usuario);
			$bd = NULL;
		?>
    </td>
  </tr>
