<?php
	...
	//$puede_entrar = $bd->getPermisos($userData,'CAN_ACCESS_OT');
	$puede_entrar = $bd->checkAccess($_SESSION["id_usuario"],26,''); //26-web otros temas
...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  <tr>
    ...
    <td align="left" valign="middle"><span class="TITULO">:: 
      Otros temas ::</span>
	  <?php
		$webOTAlta = $bd->checkPerm($_SESSION["id_usuario"],26,'alta');
		echo '<a href="'; 
		echo ($webOTAlta)?"form_varios.php?opcion=1":"#"; 
		echo '"><img src="';
		echo ($webOTAlta)?"agregar.png":"iconos_grises/agregarg.png";
...
?>
      ...
      <form action="abm_varios.php" method="post" enctype="multipart/form-data" name="form3" id="form3">
        <table align="center" class="tabla_form">
          ...
          <tr> 
            <td class="modo1"><div align="right"><font color="#000099"><strong>Texto 
                </strong></font></div></td>
            <?php 
				echo '<td class="modo2"><input name="texto" type="text" id="texto" value="' . $texto .'"' . 'size="55" maxlength="60"></td>';
			?>
          </tr>
          <tr> 
		...
		switch ($opcion){
			...
			case 2: // BAJA 
				...
				echo '<input type="hidden" name="id_varios" id="id_varios" value="'.$id_varios.'">';				
