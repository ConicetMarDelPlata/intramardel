<?php
	...
	//$puede_entrar = $bd->getPermisos($userData,'CAN_ACCESS_PIP');
...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  <tr>
    ...
    <td align="left" valign="middle"><span class="TITULO">:: 
      Proyectos PIP ::</span>
	  <?php
		$permAlta = $bd->checkPerm($_SESSION["id_usuario"],20,'alta');
		echo '<a href="'; 
		echo ($permAlta)?"form_proyecto_pip.php?opcion=1":"#"; 
		echo '"><img src="';
