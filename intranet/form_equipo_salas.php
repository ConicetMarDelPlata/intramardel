<?php
	...
	$puede_entrar = $bd->checkAccess($_SESSION["id_usuario"],36,''); //36-Equipo Salas de Reuniones
...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  <tr>
    <td class="cerrar"><p><strong><img src="images/bullet20.gif" width="9" height="9" /> <?php echo 'Usuario: '. $nombre_usuario ?></strong></p>
      <p>&nbsp;</p></td>
    <td align="left" valign="middle"><span class="TITULO">:: Equipos ::</span><a href="form_equipo_salas.php?opcion=1"><img src="agregar.png" width="25" height="25" border="0"></a> 
    </td>
  </tr>
  <tr>
    ...
    <td width="722" valign="top"> <p> 
		...
		switch ($opcion){
			...
			case 4: //CONSULTA
				$id_equipo= $_GET['id'];
				$row = $equipo->consultar_equipo($id_equipo);
				$nombre = $row["nombre"];	
				break;			
		} // FIN SWITCH
...
?>
      ...
      <form action="abm_equipo_salas.php" method="post" enctype="multipart/form-data" name="frmABMC">
