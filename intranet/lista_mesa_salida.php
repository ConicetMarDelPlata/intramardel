...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  ...
  <tr>
   ...
   <?php
	    	$permAlta = $bd->checkPerm($_SESSION["id_usuario"],2,'alta');
		if($permAlta){
			echo '<td align="left" valign="middle"><span class="TITULO">:: Mesa de Salida ::</span><a href="form_mesa_salida.php?opcion=1"><img src="agregar.png" width="25" height="25" border="0"></a> </td>';
		}else
			echo '<td align="left" valign="middle"><span class="TITULO">:: Mesa de Salida ::</span><a href="#"><img src="iconos_grises/agregarg.png" width="25" height="25" border="0"></a></td>';
	?>
  </tr>
  <tr>
    ...
    <td width="722" valign="top"> 
      <?php
	$bd->lista_mesa_salida($nombre_usuario,$_POST);
	$bd = NULL;
?>
    </td>
  </tr>
