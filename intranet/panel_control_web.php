<?php
	...
	$tpl = new tpl("templates/panel_control/web.html");
	...
	//$puede_entrar = $bd->getPermisos($userData,'CAN_ACCESS_WEB');
	
	$tpl->setVar("user",$nombre_usuario);
	$tpl->setVar("sBack","Volver");
	$tpl->setVar("linkBack","panel_control_otros.php");
	
	$oModulos   = $bd->getPanel("panel_control_web");
