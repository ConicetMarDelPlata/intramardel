<?php
	...
	$puede_entrar = $bd->checkAccess($_SESSION["id_usuario"],23,''); //23 - unhido
...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  <tr>
    ...
    Proyectos Gesti&oacute;n UNIDHO ::</span>
	  <?php
		$permAlta = $bd->checkPerm($_SESSION["id_usuario"],23,'alta');
		echo '<a href="'; 
		echo ($permAlta)?"form_proyecto_g_u.php?opcion=1":"#"; 
		echo '"><img src="';
  ...
  <tr>
    <td width="170" valign="top" background="images/divisor-columna.jpg" bgcolor="#FFFFFF" class="tituloweb2" style="background-repeat: no-repeat; background-position: right;"><font size="2">
		<?php include_once("templates/menuLateral-web.php");?>
	</td>
    <td width="722" valign="top"> 
      <?php
			$bd->lista_proyectos_g_u();
			$bd = NULL;
		?>
    </td>
  </tr>
