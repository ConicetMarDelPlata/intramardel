<?php
	...
	$puede_entrar = $bd->checkAccess($_SESSION["id_usuario"],28,''); //28-web fotos home
...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  <tr>
    <td class="cerrar"><p><strong><img src="images/bullet20.gif" width="9" height="9" /> <?php echo 'Usuario: '. $nombre_usuario ?></strong></p>
      <p>&nbsp;</p></td>
    <td align="left" valign="middle"><span class="TITULO">:: Fotos Home ::</span>
	  <?php
		$permAlta = $bd->checkPerm($_SESSION["id_usuario"],28,'alta');
		echo '<a href="'; 
		echo ($permAlta)?"form_fotos_home.php?opcion=1":"#"; 
		echo '"><img src="';
