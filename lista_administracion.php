...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  <tr>
    ...
    Publicaciones ::</span>
	  <?php
		$webAlta = $bd->checkPerm($_SESSION["id_usuario"],25,'alta');
		echo '<a href="'; 
		echo ($webAlta)?"form_administracion.php?opcion=1":"#"; 
		echo '"><img src="';
		echo ($webAlta)?"agregar.png":"iconos_grises/agregarg.png";
