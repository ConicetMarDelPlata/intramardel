<?php
	...
	$puede_entrar = $bd->checkAccess($_SESSION["id_usuario"],18,''); //18=procedimientos
...
function enviar(form){
	...
	if (document.form3.opcion.value != 2){ //SI NO ELIJE ELIMINAR
		...
		{
			alert("La descripcion del procedimiento es obligatoria.");
			return (false);
		}
		else
...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  <tr>
    ...
    <td align="left" valign="middle"><span class="TITULO">:: 
      Procedimientos ::</span><a href="form_procedimiento.php?opcion=1"><img src="agregar.png" width="25" height="25" border="0"></a> 
    </td>
  </tr>
  <tr>
    ...
    <td width="722" valign="top"> <p> 
		...
		switch ($opcion){
			...
			case 3: // OPCION MODIFICACION
				...
				$row = $bd->consultar_procedimiento_seleccion($id_procedimiento);				
				$descripcion = $row["descripcion"];
				break;			
		} // FIN SWITCH
?>
      </p>
      <form action="abm_procedimiento.php" method="post" enctype="multipart/form-data" name="form3" id="form3">
        <table align="center" class="tabla_form">
          <tr> 
            <td width="212"> </td>
          </tr>
          <tr> 
            <td class="modo1"><div align="right"><font color="#000099"><strong>Descripci&oacute;n 
                *</strong></font></div></td>
            <?php 
		echo '<td class="modo2"><input name="descripcion" type="text" id="descripcion" value="' . $descripcion .'"' . 'size="75" maxlength="100"></td>';
	  ?>
          </tr>
          <tr> 
		...
		switch ($opcion){
			...
			case 2: // BAJA 
				...
				echo '<input type="hidden" name="id_procedimiento" id="id_procedimiento" value="'.$id_procedimiento.'">';				
	...
	echo '<p align="center"><a href="lista_procedimientos.php"><img src="listar.png" width="48" height="48" border="0" /></a>';
	echo '<a href="panel_control.php"><img src="panel_control.png" width="48" height="48" border="0" /></a></p>';
	$bd = NULL;
	?>
      </form>
      <script>
