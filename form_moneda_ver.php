...
?>
      ...
      <form action="" method="post" enctype="multipart/form-data" name="form3" id="form3">
        <table align="center" class="tabla_form">
          ...
          <tr> 
            <td class="modo1"><div align="right"><font color="#000099"><strong>Signo *</strong></font></div></td>
            <?php 
		echo '<td class="modo2"><input name="signo" type="text" id="signo" value="' . $signo .'"' . 'size="55" maxlength="25" disabled></td>';
	  ?>
          </tr>
          <tr> 
            <td class="modo1"><div align="right"><font color="#000099"><strong>Descripción:</strong></font></div></td>
            <?php 
		echo '<td class="modo2"><div align="left"><input name="descripcion" type="text" id="descripcion" value="' . $descripcion .'"' . 'size="55" maxlength="25" disabled></td>';
	  ?>
          </tr>
          <tr> 
