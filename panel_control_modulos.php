<?php
	//si incluyo aca no funcionan los acentos include "includes/header.php";
	include "seguridad_bd.php";
	include_once ('includes/class.Tpl.php');

	$tpl = new tpl("templates/panel_control/modulos.php");
	...
	$oModulos   = $bd->getPanel("panel_control_modulos");
