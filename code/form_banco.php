...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  <tr>
    ...
    <td align="left" valign="middle"><span class="TITULO">:: 
      Bancos ::</span><a href="form_banco.php?opcion=1"><img src="agregar.png" width="25" height="25" border="0"></a> 
    </td>
  </tr>
  <tr>
...
?>
      ...
      <form action="abm_banco.php" method="post" enctype="multipart/form-data" name="form3" id="form3">
        <table align="center" class="tabla_form">
          ...
          <tr> 
            <td class="modo1"><div align="right"><font color="#000099"><strong>Nombre 
                *</strong></font></div></td>
            <?php 
		echo '<td class="modo2"><input name="nombre" type="text" id="nombre" value="' . $nombre .'"' . 'size="55" maxlength="45"></td>';
	  ?>
          </tr>
          <tr> 
		...
		switch ($opcion){
			case 1: // ALTA  
				...
				echo '<input type="hidden" name="id_banco" id="id_banco" value="'.$id_banco.'">';				
