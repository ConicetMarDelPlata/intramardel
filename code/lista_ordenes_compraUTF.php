...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  ...
  <tr>
   ...
   <?php
		...
		if($permAlta){
			echo '<td align="left" valign="middle"><span class="TITULO">:: Ordenes de Compra ::</span><a href="form_orden_compra.php?opcion=1"><img src="agregar.png" width="25" height="25" border="0"></a></td>';
		}else
			echo '<td align="left" valign="middle"><span class="TITULO">:: Ordenes de Compra ::</span><a href="#"><img src="iconos_grises/agregarg.png" width="25" height="25" border="0"></a></td>';
	?>
  </tr>
  <tr>
