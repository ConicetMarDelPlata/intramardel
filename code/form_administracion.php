...
include "./includes/header.php";
	...
	//$puede_entrar = $bd->getPermisos($userData,'CAN_ACCESS_ADM');
	$puede_entrar = $bd->checkAccess($_SESSION["id_usuario"],25,''); //25=web administracion
...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  <tr>
    <td class="cerrar"><p><strong><img src="images/bullet20.gif" width="9" height="9" /> <?php echo 'Usuario: '. $nombre_usuario ?></strong></p>
      <p>&nbsp;</p></td>
    <td align="left" valign="middle"><span class="TITULO">:: Administración: </span>
	  <?php
		$webAdmAlta = $bd->checkPerm($_SESSION["id_usuario"],25,'alta');
		echo '<a href="'; 
		echo ($webAdmAlta)?"form_administracion.php?opcion=1":"#"; 
		echo '"><img src="';
		echo ($webAdmAlta)?"agregar.png":"iconos_grises/agregarg.png";
...
?>
      <form action="abm_administracion.php" method="post" enctype="multipart/form-data" name="form3" id="form3">
	  ...
	  ?>
          ...
          <tr> 
            <td class="modo1"><div align="right"><font color="#000099"><strong>Unidad 
                Ejecutora:</strong></font></div></td>
            <?php 
		...
		switch ($opcion){
			...
			case 2: // BAJA 
				...
				echo '<input type="hidden" name="id_administracion" id="id_administracion" value="'.$id_administracion.'">';
