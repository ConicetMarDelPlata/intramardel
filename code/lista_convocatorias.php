...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  <tr>
    ...
    Convocatorias ::</span>
	  <?php
		echo '<a href="'; 
		echo ((bool)$bd->userData['web_Conv_alta'])?"form_convocatoria.php?opcion=1":"#"; 
		echo '"><img src="';
		echo ((bool)$bd->userData['web_Conv_alta'])?"agregar.png":"iconos_grises/agregarg.png";
