...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  <tr>
    <td class="cerrar"><p><strong><img src="images/bullet20.gif" width="9" height="9" /> <?php echo 'Usuario: '. $nombre_usuario ?></strong></p>
      <p>&nbsp;</p></td>
	 <?php
		$permAlta = $bd->checkPerm($_SESSION["id_usuario"],31,'alta');
		if($permAlta == 1){
  	  		echo '<td align="left" valign="middle"><span class="TITULO">:: Feriados ::</span><a href="form_feriado.php?opcion=1"><img src="agregar.png" width="25" height="25" border="0"></a></td>';
		}else
			echo '<td align="left" valign="middle"><span class="TITULO">:: Feriados ::</span><a href="#"><img src="iconos_grises/agregarg.png" width="25" height="25" border="0"></a></td>';
	?>  
  </tr>
  <tr>
    ...
    <td width="722" valign="top"> 
		<?php
		if($bd->checkPerm($_SESSION["id_usuario"],31,'consulta')){
			$feriados->lista_feriados($_REQUEST);
			$bd = NULL;
		}
