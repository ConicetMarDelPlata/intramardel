...
?>
      ...
      <form action="" method="post" enctype="multipart/form-data" name="form3" id="form3">
        <table align="center" class="tabla_form">
          ...
          <tr> 
            <td class="modo1"><div align="right"><font color="#000099"><strong>Título, 
                nombre y apellido *</strong></font></div></td>
            <?php 
		echo '<td class="modo2"><input name="titulo_apellido_nombre" type="text" id="titulo_apellido_nombre" value="' . $titulo_apellido_nombre .'"' . 'size="55" maxlength="25" disabled></td>';
	  ?>
          </tr>
          <tr> 
            <td class="modo1"><div align="right"><font color="#000099"><strong>Cargo:</strong></font></div></td>
            <?php 
		echo '<td class="modo2"><input name="cargo" type="text" id="cargo" value="' . $cargo .'"' . 'size="55" maxlength="25" disabled></td>';
	  ?>
          </tr>
          <tr> 
            <td class="modo1"><div align="right"><font color="#000099"><strong>Lugar:</strong></font></div></td>
            <?php 
		echo '<td class="modo2"><input name="lugar" type="text" id="lugar" value="' . $lugar .'"' . 'size="55" maxlength="25" disabled></td>';
	?>
          </tr>
          <tr> 
