...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  <tr class="cerrar" >
    <td><p><strong><img src="images/bullet20.gif" width="9" height="9" /> <?php echo 'Usuario: '. $nombre_usuario ?></strong></p>
    <p>&nbsp;</p></td>
  ...
  <tr>	
    ...
    <td width="722" valign="top"> 
      <?php
		if($bd->checkPerm($_SESSION["id_usuario"],19,'consulta')){
			$bd->lista_usuarios($_REQUEST);
			$bd = NULL;
		}
		?>
    </td>
