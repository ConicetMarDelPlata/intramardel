<?php
	...
	$puede_entrar = $bd->checkAccess($_SESSION["id_usuario"],24,''); //24-licitaciones
...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  <tr>
    ...
    Licitaciones ::</span>
	  <?php
		$permAlta = $bd->checkPerm($_SESSION["id_usuario"],24,'alta');
		echo '<a href="'; 
		echo ($permAlta)?"form_licitacion.php?opcion=1":"#"; 
		echo '"><img src="';
