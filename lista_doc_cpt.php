<?php
	...
	$oTpl = new tpl("templates/rendiciones/dcpt/lista.php");
	...
	//$puede_entrar = $bd->getPermisos($userData,'CAN_ACCESS_DOC_CPT');
	$puede_entrar = $bd->checkAccess($_SESSION["id_usuario"],9,''); //9-doc cpt
