<?php
	...
	//$puede_entrar = $bd->getPermisos($userData,'CAN_ACCESS_FH');
	$puede_entrar = $bd->checkAccess($_SESSION["id_usuario"],28,''); //28=fotos home
...
function enviar(form){
	...
	/*if (document.form3.opcion.value != 2){ //SI NO ELIJE ELIMINAR
		if (document.form3.archivo1.value == "") 
		{
...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  <tr>
    ...
    <td align="left" valign="middle"><span class="TITULO">:: 
      Fotos Home ::</span> 
	  <?php
		$webFHAlta = $bd->checkPerm($_SESSION["id_usuario"],28,'alta');
		echo '<a href="'; 
		echo ($webFHAlta)?"form_fotos_home.php?opcion=1":"#"; 
		echo '"><img src="';
		echo ($webFHAlta)?"agregar.png":"iconos_grises/agregarg.png";
...
?>
      ...
      <form action="abm_fotos_home.php" method="post" enctype="multipart/form-data" name="form3" id="form3">
		...
		switch ($opcion){
			...
			case 2: // BAJA 
				...
				echo '<input type="hidden" name="id_foto" id="id_foto" value="'.$id_foto.'">';				
