<?php
	...
	$puede_entrar = $bd->checkAccess($_SESSION["id_usuario"],21,''); //21 - web coop internaciones
...
<table width="898" height="346" border="0" align="center" cellpadding="0">
  <tr>
    ...
    Proyectos de Cooperaci&oacute;n Internacional ::</span>
	  <?php
		$permAlta = $bd->checkPerm($_SESSION["id_usuario"],21,'alta');
		echo '<a href="'; 
		echo ($permAlta)?"form_proyecto_c_i.php?opcion=1":"#"; 
		echo '"><img src="';
